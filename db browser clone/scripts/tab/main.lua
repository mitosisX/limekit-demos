...
dbTab:addTabItem(dbStructureTab, "Database Structure")
dbTab:addTabItem(browseDataTab, "Browse Data")
dbTab:addTabItem(editPragramsTab, "Edit Pragrams")
dbTab:addTabItem(executeSQLTab, "Execute SQL")